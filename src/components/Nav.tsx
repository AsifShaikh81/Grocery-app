...
function Nav({ user }: { user: IUser }) {
        ...
        <AnimatePresence>
          <motion.div
            ...
            className="fixed top-0 left-0 h-full w-[75%] sm:w-[60%] z-9999
              bg-linear-to-b from-[#D94E14] to-[#f15d1eaf]
              backdrop-blur-xl border-r border-[#D94E14]
          ...
          >
            ...
            <div className="flex items-center gap-3 p-3 mt-3 rounded-xl bg-white/10 hover:bg-white/15 transition-all shadow-inner">
              <div className="relative w-12 h-12 rounded-full overflow-hidden border-2 border-[#F7F2D7] shadow-lg">
                {" "}
                {user.image ? (
                  <Image
                    src={user.image}
              ...
              <div>
                ...
                <p className="text-xs text-white capitalize tracking-wide">
                  {user.role}
                </p>
              </div>
            </div>
            ...
            <div
              className="flex items-center gap-3 text-white font-semibold mt-auto hover:bg-red-500/20 p-3 rounded-lg transition-all"
  ...
  return (
    <div className="w-[95%] fixed top-4 left-1/2 -translate-x-1/2 bg-linear-to-r from-[#F25A1A] to-[#D94E14] rounded-2xl shadow-lg shadow-black/30 flex justify-between items-center h-20 px-4 md:px-8 z-50">
      <Link
        href={"/"}
        ...
        {user.role == "admin" && (
          <>
            <div className="hidden md:flex items-center gap-4">
              <Link
                href={"/admin/add-grocery"}
                className="flex items-center gap-2 bg-white text-[#F25A1A] font-semibold px-4 py-2 rounded-full hover:bg-[#F7F2D7] transition-all"
              >
                <PlusCircle className="w-5 h-5" /> Add Grocery
              </Link>
              <Link
            ...
            >
              <Menu className="text-[#F25A1A] w-6 h-6" />
            </div>
          </>
        )}
            ...
            {open && (
              ...
              >
                <div className="flex items-center gap-3 px-3 py-2 border-b border-gray-100">
                  <div className="w-10 h-10 relative rounded-full bg-[#f15d1eaf] flex items-center justify-center overflow-hidden">
                    {user.image ? (
                      <Image
                        src={user.image}
                        alt="user"
                ...
                {user.role == "user" && (
                  ...
                  >
                    <Package className="w-5 h-5 text-[#F25A1A]" />
                    My Orders
                  </Link>
                )}
