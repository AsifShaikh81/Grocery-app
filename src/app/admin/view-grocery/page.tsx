  ...
  return (
    <div className="pt-4 w-[95%] md:w-[85%] mx-auto pb-20">
      ...
      >
        <button
          onClick={() => router.push("/")}
          className="flex items-center justify-center gap-2 bg-[#f15d1eaf] hover:bg-[#D94E14] text-[#F7F2D7] font-semibold px-4 py-2 rounded-full transition w-full sm:w-auto"
        >
          <ArrowLeft size={18} />
          <span>Back</span>
        </button>
        <h1 className="text-2xl md:text-3xl font-extrabold text-[#F25A1A] flex items-center justify-center gap-2">
          <Package size={28} className="text-[#F25A1A]" />
          Manage Groceries
        </h1>
      </motion.div>
          ...
          >
            ...
            <div className="flex-1 flex flex-col justify-between w-full">
              ...
              <div className="mt-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                <p className="text-[#F25A1A] font-bold text-lg">
                  ₹{g.price}/{" "}
                ...
                <button
                  className="bg-[#F25A1A] text-white px-4 py-2 rounded-lg text-sm font-semibold flex items-center justify-center gap-2 hover:bg-[#D94E14] transition-all"
          ...
          >
            ...
            >
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-bold text-[#F25A1A]">
                  Edit Grocery
                </h2>
                <button
              ...
              <div className="relative aspect-square w-full rounded-lg overflow-hidden mb-4 border border-gray-200 group">
                ...
                >
                  <Upload size={28} className="text-[#F25A1A]" />
                </label>
                <input
                  type="file"
                  accept="image/*"
              ...
              <div className="space-y-4">
                <input
                  ...
                  className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-[#F25A1A] outline-none"
                />

                <select
                  className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-[#F25A1A] outline-none bg-white"
              ...
              <div className="flex justify-end gap-3 mt-6">
                <button
                  className="px-4 py-2 rounded-lg bg-[#F25A1A] text-white flex items-center gap-2 hover:bg-[#D94E14] transition-all"
                  onClick={handleEdit}
                  disabled={loading}
                >
